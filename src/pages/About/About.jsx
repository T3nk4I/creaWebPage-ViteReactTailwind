    ...
    <div className='p-0 mt-20 bg-dark w-full min-h-screen'>
      <div className='lg:flex items-center'>
        <div className='w-full lg:w-1/2'>
          <img src={creaLogo} alt='nuestro logo' className='h-full mx-auto' />
        </div>
        <div className=' w-full lg:w-1/2 '>
      ...
      <div className='w-screen px-8 lg:px-0 lg:flex lg:py-10 lg:mt-12'>
        <div className=' pt-2 mt-10 lg:mt-4 lg:w-1/2 lg:pl-8'>
          <h2 className='font-bold text-xl sm:text-lg md:text-2xl lg:text-3xl xl:text-4xl pl-4 tracking-wide mb-4 text-primary'>
            Visión
          </h2>
          <p className='p-2 px-4 max-w-prose font-medium md:text-lg xl:text-xl '>
