...
export default function Hero () {
  ...
  return (
    <div className='w-full mb-20 bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] to-black from-bg_accent_dark/70'>
      <h1 className='w-full text-center text-5xl font-extrabold bg-clip-text text-transparent bg-gradient-to-br from-txt_white to-txt_white_purple md:pt-20 md:text-6xl lg:pt-32 lg:text-7xl xl:text-8xl xl:pt-40'>Xmas <span className='bg-clip-text text-transparent bg-gradient-to-tr from-accent to-secondary'>2024</span></h1>
      ...
      <div className='flex flex-col w-fit mt-12 mx-auto text-center font-medium text-sm md:flex-row md:w-1/3 md:text-base md:mt-16 lg:text-lg lg:mt-24 xl:text-xl xl:mt-28'>
        <button className='flex-1 h-fit px-4 py-2 rounded-lg text-black bg-primary'><Link to='https://docs.google.com/forms/d/e/1FAIpQLSdPmPZQSUtVt3pN-Dk3IOiIFgLFZ8DT6pNls18MvjHuOVF6lQ/viewform?usp=sf_link'>Inscribete</Link></button>
