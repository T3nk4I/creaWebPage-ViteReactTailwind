...
export default function Hero () {
  ...
  return (
    <div className='w-full mb-10 bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] to-black from-bg_accent_dark/70 md:mb-14 lg:mb-20'>
      ...
      <div className='flex flex-col w-fit mt-12 mx-auto text-center font-medium text-sm md:flex-row md:w-1/3 md:text-base md:mt-16 lg:text-lg lg:mt-24 xl:text-xl xl:mt-28'>
        <button className='flex-1 flex cursor-default h-fit px-4 py-2 rounded-lg text-black bg-primary hover:bg-secondary/85 hover:scale-105 '><Link className='flex-1 active:text-white hover:font-semibold cursor-pointer' to='https://docs.google.com/forms/d/e/1FAIpQLSeibZ72C2mAxaysksWpbAc2JV6nWeZOvuzDmYRPu1lkU7ZGPQ/viewform'>Inscribete</Link></button>

        <button className='flex-1 w-full h-fit mt-4 mb-12 px-4 py-2 rounded-lg text-txt_white_purple/60 bg-bg_accent_dark hover:bg-accent/85 hover:scale-105 active:text-white hover:font-semibold md:mt-0 md:ml-8 md:mb-16 lg:mb-24 xl:mb-32' onClick={joke}>Precios</button>
      </div>
    </div>
  )
}
