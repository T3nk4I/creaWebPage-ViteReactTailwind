  ...
  return (
    <div className="p-0 m-0 w-screen ">
      <div className="h-screen">
        <section className=" bg-white h-14 xl:h-16 2xl:h-20 w-full mt-3 lg:mt-2 px-2 sticky top-0">
          <Header></Header>
        </section>
        <section className="h-full w-full bg-black mt-4">
          <div className=" h-3/5 w-full border border-primary-light">
            <Categories />
          </div>
